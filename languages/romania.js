			...
			COMMANDS_SERVER: {
				...
				settingsValue: settings =>
					[
						...
						`Mesaje de AFK de trimis: ${settings.settings.allowAfkResponses}`,
						`Feedback Feature: **Idee:** ${settings.settings.feedback.idea.status} | **Probleme**: ${settings.settings.feedback.bug.status}`
					].join('\n')
			},
